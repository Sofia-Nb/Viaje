 ...
 */
 ...
 class ResponsableV{
    ...
    public function __toString(){
        $cartel = "Número de empleado: ".$this->getNumEmpleado()."\n";
        $cartel .= "Número de licencia: ".$this->getNumLicencia()."\n";
        $cartel .= "Nombre: ".$this->getNombre()."\n";
        $cartel .= "Apellido: ".$this->getApellido()."\n";
        $cartel .= "***************************************\n";
        return $cartel;
    }
 }